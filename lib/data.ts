...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "A MERN stack chat application with real-time messaging, private & group chats, online status, JWT authentication, media uploads via Cloudinary, and a responsive UI built with React, TailwindCSS, and DaisyUI. Powered by Socket.io for live communication and ready for production deployment.",
  ...
  },
  {
    ...
    image: "/images/resort-booking.png",
  },
    {
    id: 4,
